...
export function CollectionsSection() {
  ...
  return (
    <section ref={sectionRef} id="collections" className="py-20 md:py-32 bg-foreground text-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4">Collections</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {collections.map((collection, index) => (
            <div
              key={collection.id}
              className={cn(
                "group relative aspect-[3/4] overflow-hidden rounded-lg cursor-pointer transition-all duration-700",
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8",
              )}
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-background p-6">
                ...
                <p className="text-background/80 text-center mb-4">{collection.description}</p>
                <Button
                  variant="outline"
                  size="sm"
