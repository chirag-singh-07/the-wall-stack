...
export function CheckoutSummary({ shippingMethod, onPlaceOrder, isProcessing }: CheckoutSummaryProps) {
  ...
  return (
    <div className="bg-muted/30 rounded-2xl p-6 space-y-6 border border-border sticky top-24">
      ...
      {/* Place Order Button */}
      <Button className="w-full h-12 text-base" onClick={onPlaceOrder} disabled={isProcessing || items.length === 0}>
        {isProcessing ? (
          <>
      ...
      <div className="grid grid-cols-3 gap-2 pt-4 border-t border-border">
        <div className="text-center space-y-1.5">
          ...
          <p className="text-[10px] text-muted-foreground leading-tight">Fast Shipping</p>
        </div>
        <div className="text-center space-y-1.5">
          <div className="w-8 h-8 mx-auto rounded-full bg-background flex items-center justify-center border border-border">
            <Shield className="h-4 w-4" />
          </div>
          <p className="text-[10px] text-muted-foreground leading-tight">Secure Checkout</p>
        </div>
        <div className="text-center space-y-1.5">
          <div className="w-8 h-8 mx-auto rounded-full bg-background flex items-center justify-center border border-border">
            <RotateCcw className="h-4 w-4" />
          </div>
          <p className="text-[10px] text-muted-foreground leading-tight">Easy Returns</p>
        </div>
      </div>
