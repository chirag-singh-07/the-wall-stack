...
} from "@/actions/admin/admin-reset-actions";
...
export default function AdminForgotPasswordPage() {
  ...
  const handleCodeSubmit = async (e: React.FormEvent) => {
    try {
      ...
      setIsLoading(true);
      // Verify the code with the server action
      const res = await verifyForgotPasswordCode(formData.secretCode);
      if (!res.success) {
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 text-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {step === "code"
                    ? "You need to provide the secret code to reset your admin password."
                ...
                <div className="relative">
                  ...
                  <div
                    className={cn(
                      ...
                      focusedField === "secretCode" ? "w-full" : "w-0"
                    )}
                  />
                </div>
              </div>
          ...
          <div className="space-y-3 pt-4 border-t border-border">
            <div className="text-center">
              ...
              >
                ...
                {step === "reset" ? "Back to code" : "Back to login"}
              </button>
            </div>
          </div>
        </div>
