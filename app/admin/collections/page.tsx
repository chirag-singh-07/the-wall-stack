...
import { useAdminStore, type AdminCollection } from "@/lib/admin-store"
...
export default function AdminCollectionsPage() {
  const { collections, deleteCollection } = useAdminStore()
    ...
    <div className="min-h-screen">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-muted-foreground">Organize your posters into collections</p>
          </div>
          <Button asChild>
        ...
        {collections.length === 0 && (
          <div className="rounded-lg border border-dashed border-border p-12 text-center">
            ...
            <p className="mt-2 text-muted-foreground">Create your first collection to organize your posters</p>
  ...
  return (
    <div className="group relative overflow-hidden rounded-lg border border-border bg-card transition-all hover:border-foreground/20 hover:shadow-lg">
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-muted">
        ...
        <Badge
          variant="outline"
          className={`absolute right-3 top-3 ${collection.status === "active" ? "bg-green-100 text-green-800 border-green-200" : "bg-yellow-100 text-yellow-800 border-yellow-200"}`}
        >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          ...
          <p className="text-sm text-white/80">{collection.productCount} products</p>
        </div>
      </div>
