    ...
    items: [
      {
        ...
        image: "/default-images/minimal-geometric-black-white-poster-art.jpg",
        size: "A3 (30×42cm)",
        quantity: 1,
        price: 49,
      },
    ...
    items: [
      {
        productId: "5",
        title: "Chaos Theory",
        image: "/default-images/abstract-chaotic-black-white-poster-art.jpg",
        size: "A1 (59×84cm)",
        quantity: 2,
        price: 155,
      },
    ...
    items: [
      {
        productId: "2",
        title: "Abstract Flow",
        image: "/default-images/abstract-fluid-black-white-poster-art.jpg",
        size: "A2 (42×59cm)",
        quantity: 1,
        price: 89,
      },
      {
        ...
        image: "/default-images/typography-bold-black-white-poster-art.jpg",
        size: "A3 (30×42cm)",
        quantity: 1,
        price: 45,
      },
    ...
    items: [
      {
        productId: "7",
        title: "Void Space",
        image: "/default-images/minimal-void-space-black-white-poster-art.jpg",
        size: "A1 (59×84cm)",
        quantity: 1,
        price: 115,
      },
...
const sampleProducts: AdminProduct[] = [
  ...
  },
  {
    ...
    price: 55,
    category: "minimal",
    image: "/default-images/minimal-lines-black-white-poster-art.jpg",
...
const sampleCollections: AdminCollection[] = [
  {
    ...
    image: "/default-images/minimal-collection-black-white-poster-art.jpg",
    productCount: 5,
    status: "active",
  ...
  },
  {
    ...
    image: "/default-images/abstract-collection-black-white-poster-art.jpg",
    productCount: 5,
    status: "active",
    createdAt: "2024-01-01",
  },
  {
    ...
    image: "/default-images/typography-collection-black-white-poster-art.jpg",
    productCount: 4,
    status: "active",
    createdAt: "2024-01-01",
  },
